...
def pointDist(point1, pointlist):
    ...
    latitude = point1.y
    longitude = point1.x
    distances = [haversine((latitude, longitude), point2) for point2 in pointlist]
...
def cropCalendarParser(unit_name_start, crop_cal_name='cropping_calendar_rainfed.txt'):
    ...
    for root, dirs, files in os.walk('../resources/'):
        for file in files:
            if file == crop_cal_name:
                crop_cal_name = os.path.join(root, file)
